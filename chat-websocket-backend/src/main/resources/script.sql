...
ALTER TABLE `RSERVATION` ADD FOREIGN KEY (`utilisateur_id`) REFERENCES `UTILISATEUR` (`id`);
ALTER TABLE `RSERVATION` ADD FOREIGN KEY (`offre_location_id`) REFERENCES `OFFRE_LOCATION` (`id`);
